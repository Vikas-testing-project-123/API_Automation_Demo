...
#
# def test_deleteDeviceId():
#     url = baseUrlHeader.baseURL+"/deleteDeviceId"
#     excelPath = "C:\\Users\\TA0134\\PycharmProjects\\API_Testing\\TestData\\UserLogin.xlsx"
#     testcases = ["Blank Company Domain", "Blank UserId", "Blank Firesbase_Token", "Blank DeviceId", "All Blank",
#                  "Invalid Company Domain", "All Invalid"]
#     testcases1 = ["Blank Company Domain"]
#     for test in testcases:
#         print("*************************" + test + "******************************")
#         testData = Read_Excel(excelPath, "deleteDeviceId", test)
#         i = 0
...
#         file = open('C:\\Users\\TA0134\\PycharmProjects\\API_Testing\\Json_files\\deleteDeviceId.json', 'r')  # open the file in read only mode
...
#         json_input = update_content(json_input, "Firebase_Token", testData[2])
#         json_input = update_content(json_input, "DeviceId", testData[3])
#
...
#             write_Excel(excelPath, "deleteDeviceId", test, "Pass:- "+response.text)
#         else:
#             write_Excel(excelPath, "deleteDeviceId", test, "Fail-"+response.text)
#
