...
#     url = "http://bam.kockpit.in:4001/getNotifications"
...
#         print("*************************" + test + "******************************")
#         testData = Read_Excel(excelPath, "getNotification", test)
#         i = 0
...
#         file = open('C:\\Users\\TA0134\\PycharmProjects\\API_Testing\\Json_files\\getNotification.json', 'r')  # open the file in read only mode
...
#             write_Excel(excelPath, "getNotification", test, "Pass:- "+response.text)
#         else:
#             write_Excel(excelPath, "getNotification", test, "Fail-"+response.text)
#
