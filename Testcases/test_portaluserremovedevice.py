...
def test_portaluserremovedevice():
    ...
    for test in testcases:
        print("*************************" + test + "******************************")
        testData = Read_Excel(excelPath, "portaluserremovedevice", test)
        i = 0
        ...
        file = open('C:\\Users\\TA0134\\PycharmProjects\\API_Testing\\Json_files\\portaluserremovedevice.json', 'r')  # open the file in read only mode
